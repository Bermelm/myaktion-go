...
//über die Notation nach dem typen wird festgelegt, wie die Datenbank ("gorm") mit den eingegebenen Daten umgeht. Bspw. Felder die befüllt werden müssen, maximale Größen, etc.
